                ...
                <div className="story-container">
                    <div className="story-content">
                        <div className="story-text" data-aos="fade-right">
                            ...
                            {aboutCopy.story.sections ? (
                                <div className="story-sections-wrapper">
                                    {aboutCopy.story.sections.map((section, sectionIndex) => (
                                        <div key={sectionIndex} className="story-section-content">
                                            <h3 className="story-section-heading">{section.heading}</h3>
                                            <div className="story-points-container">
                                                {section.points.map((point, pointIndex) => (
                                                    <div key={pointIndex} className="story-point-item">
                                                        <div className="story-point-icon">✓</div>
                                                        <p className="story-point-text">{point}</p>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
